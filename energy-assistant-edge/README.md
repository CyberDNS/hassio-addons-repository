# Home Assistant Add-on: Energy Assistant (edge)

__This is the edge channel of Energy Assistant. It runs a tagged, validated version that hasn't yet been promoted to the stable channel.__
...
The edge channel tracks the most recently tagged release of [CyberDNS/energy-assistant](https://github.com/CyberDNS/energy-assistant). It is updated whenever a new tag's GitHub Release is published.
...
2. Install **Energy Assistant (edge)**.
