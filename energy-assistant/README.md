# Home Assistant Add-on: Energy Assistant
...
This is the stable channel: it runs whichever version a maintainer has promoted from edge after validating it.
